<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown"
                {{ setActive(['admin.category.*', 'admin.sub-category.*', 'admin.child-category.*']) }}>
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                        class="fas fa-columns"></i><span>Manaje categories</span></a>
            ...
            <li class="dropdown  {{ setActive(['admin.vendor-profile.*']) }} ">
                ...
                <ul class="dropdown-menu">
                    <li
                        class="{{ setActive(['admin.vendor-profile.*']) }} ">
            ...
            <li class="dropdown  {{ setActive(['admin.slider.*']) }} ">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                        class="fas fa-columns"></i><span>Manaje Website</span></a>
                <ul class="dropdown-menu">
