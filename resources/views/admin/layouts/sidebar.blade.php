    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown  {{ setActive([
                ...
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i><span>Manaje Product</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown  {{ setActive([
                ...
                <ul class="dropdown-menu">
                    <li class=""><a class="nav-link" href="{{ route('admin.vendor-profile.index') }}">Vendor Profile</a></li>
                </ul>
            </li>
