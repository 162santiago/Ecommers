                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="">Prewiew Image</label>
                                    <br>
                                    <img style="width: 200px" src="{{ asset($product->thumb_image) }}" alt="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="" name="name" class="form-control" value="name">
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="">Sku</label>
                                    <input type="text" placeholder="" name="sku" class="form-control" value="sku">
                                </div>

                                <div class="form-group">
                                    <label for="">Price</label>
                                    <input type="text" placeholder="" name="price" class="form-control" value="price">
                                </div>
